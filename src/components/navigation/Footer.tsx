    ...
    return (
        ...
        <footer className="w-full h-full flex flex-col  overflow-x-hidden bg-primary text-primary-foreground p-4 mt-4">
            <div className="w-full h-full flex flex-col md:flex-row items-center align-top gap-4">
                ...
                {/* social links */}
                <div className=" flex-1 flex flex-col justify-center gap-4 text-left sm:border-b md:border-none">
                    <Link resetScroll={true} to="/events" className="w-fit text-sm hover:text-sky-400 font-semibold underline cursor-pointer" search={{
                        city: 'all',
                    }}>Events</Link>
                    <Link resetScroll={true} to="/events" search={{
                        city: 'mombasa',
                    }} className="w-fit text-sm hover:text-sky-400 font-semibold underline cursor-pointer">Mombasa</Link>
                    <Link resetScroll={true} to="/events" search={{
                        city: 'Nairobi',
                    }} className="w-fit text-sm hover:text-sky-400 font-semibold underline cursor-pointer">Nairobi</Link>
                    <Link resetScroll={true} to="/contact" className="w-fit text-sm hover:text-sky-400 font-semibold underline cursor-pointer">Contact Us</Link>
                </div>
            ...
            <ul className="flex items-center justify-center gap-4 border-t text-sm list-inside list-disc  contain-style">
                <li>
                    <Link to="/" className="font-semibold hover:text-sky-400">Home</Link>
                </li>
                <li>
                    <Link to="/about" className="font-semibold hover:text-sky-400">About</Link>
                </li>
                <li>
                    <Link to="/contact" className="font-semibold hover:text-sky-400">Contact</Link>
                </li>
                <li>
                    <Link to="/policy" className="font-semibold hover:text-sky-400">Privacy Policy</Link>
                </li>
