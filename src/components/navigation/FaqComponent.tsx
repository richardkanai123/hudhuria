    ...
    return (
        <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
                ...
                <AccordionContent>
                    To buy tickets, browse the events listed on our website, select the event you are interested in, and click the "Buy Tickets" button. You will be prompted to enter your payment details, and upon successful payment, you will receive a confirmation email with your e-ticket.
                </AccordionContent>
            </AccordionItem>
