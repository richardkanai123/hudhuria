            ...
            <div className="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg">
                <section id="about-us">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sky-800 font-normal">
                            Whether you're hosting a small local gathering or a large-scale conference, [Website Name] provides you
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sky-800 font-normal">
                            ...
                            [Website Name], you're not just getting an event listing platform—you're gaining a partner in bringing your
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sky-800 font-normal">
                            Whether you're an event organizer looking for a platform to promote your event or an attendee eager to
                    ...
                    <div className="mt-10">
                        ...
                        <Link to="/policy" resetScroll={true} className="text-sky-800 hover:text-sky-900 underline">
                            Terms and Policy
                        </Link>
                    </div>
                </section>
