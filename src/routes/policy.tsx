        ...
        <section id="terms-of-service">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Welcome to Hudhuria. These Terms of Service ("Terms") govern your use of our website and services. By accessing or using our website, you agree to comply with and be bound by these Terms. If you do not agree with any of the Terms, please do not use our website.
            </p>
          </div>
